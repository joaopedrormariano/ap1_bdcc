...
SECRET_KEY = 'django-insecure-*rb+7iv+hhpj(h4-ykx&^5736n#%3gl4l^20h75kduli!t@0%e'

# Configuração de DEBUG - True para desenvolvimento, False na AWS
DEBUG = True if os.getenv('DJANGO_DEBUG', 'True') == 'True' else False

# Hosts permitidos (Importante para o Elastic Beanstalk não bloquear o acesso)
...
# Configuração de arquivos de mídia (Preparado para S3 futuro)
if DEBUG:
